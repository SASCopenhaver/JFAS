...
tGrStruct = structNew();
tGrStruct = application.ographicsUtils.graphicSetForAAPPNum( url.aapp, session.userID, "Cumulative FMS by Execution Date", "JFGFCompFMS" );
