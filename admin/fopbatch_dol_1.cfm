...
--->
<cfset request.pageID="2510">
<cfset request.htmlTitleDetail = "Job Corps Fund Allocation System - FOP Batch Process (DOL)">
<cfset request.pageTitleDisplay = "FOP Batch Process for DOL Contracts: PY #evaluate(request.py+1)#">
</cfsilent>
...
<form action="fopbatch_dol_2.cfm" method="post">
