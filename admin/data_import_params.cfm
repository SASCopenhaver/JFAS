...
description: Edit data import parameters
...
<cfif isDefined("form.btnSave")> <!--- coming from form submittal --->
	...
	<cfinvoke component="#application.paths.components#import_data" method="saveDataImportParams" importType="NCFMSFOOT" formData="#form#" >
	<cflocation url="#cgi.SCRIPT_NAME#?saved=1">
<cfelse>
	<cfinvoke component="#application.paths.components#import_data" method="getDataImportParams" importType="NCFMSFOOT" returnvariable="rstDataImportParams">
...
<h2>Data Import Parameters: NCFMS PO Sublegder Extract</h2>
