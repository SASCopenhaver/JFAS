...
--==============================================================================
PROCEDURE sp_getSPlanNextYear ( argUserID IN VARCHAR2
                               ,rc_CurrentPY             OUT refc_Base     -- Current Program Year
...
/*
PROCEDURE sp_getSPlanNextYear_2 ( argUserID IN VARCHAR2
                                ,rc_DataOut OUT refc_Base
                               ,rc_CurrentPY             OUT refc_Base     -- Current Program Year
                               --,rc_getAmount_CTR_FED_HQC OUT refc_Base     -- CENTERS, USDA, NATIONAL HQ CONTRACTS 
                               --,rc_getAmount_GT          OUT refc_Base     -- GRAND TOTAL
                               --,rc_getAmount_APPRP       OUT refc_Base     -- APPROPRIATION
...
BEGIN
--------------------------------------------------------------------------------
INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (10, 'Beginning of SP', SYSDATE );
--------------------------------------------------------------------------------
OPEN rc_CurrentPY FOR
SELECT v_CurrentPY  AS CURRENT_PY
...
END IF;
--------------------------------------------------------------------------------
INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (20, 'End of SP', SYSDATE );
--------------------------------------------------------------------------------
END sp_getSPlanNextYear;
...
COMMIT;
--------------------------------------------------------------------------------
INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (20, 'rc_getAmount_CTR_FED_HQC starts', SYSDATE );
OPEN rc_getAmount_CTR_FED_HQC FOR -- CENTERS, USDA, NATIONAL HQ CONTRACTS:
        -- NOTE: pseudocolumn SYS_CONNECT_BY_PATH() returns string with the leading "," (',3,56,789')
        --       removing "," by SUBSTR(SYS_CONNECT_BY_PATH(ml.SPLAN_CAT_ID, ','), 2), gives this result: '3,56,789'
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (30, 'rc_getAmount_GT starts', SYSDATE );
--------------------------------------------------------------------------------
...
INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (40, 'rc_getAmount_APPRP starts', SYSDATE );
...
INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (50, 'rc_getAmount_BBR starts', SYSDATE );
...
INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (60, 'rc_getAmount_RES starts', SYSDATE );
...
INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (70, 'rc_getAmount_BAR starts', SYSDATE );
...
INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (80, 'rc_getResPercent starts', SYSDATE );
...
INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (90, 'rc_TransClosed starts', SYSDATE );
...
INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (100, 'sp_getAmountsFutureSPlan ends', SYSDATE );
...
DELETE SPLAN_NEXT_YEAR_TEMP; --COMMIT;

INSERT INTO SPLAN_NEXT_YEAR_TEMP ( SORT_ORDER, OUTPUT_TYPE, PATH, H_LEVEL, SPLAN_CAT_ID,
                                   SPLAN_CAT_ID_ORG, SPLAN_CAT_PARENT_ID, SPLAN_CAT_DESC,
                                   NOTE_NEXT_YEAR_PY, SPLAN_SECTION_CODE, AMOUNT_AS_OF_TODAY,
                                   AMOUNT_NEXT_YEAR_FOP,  AMOUNT_NEXT_YEAR_PY )
SELECT SEQ_SPLAN_NEXT_YEAR_TEMP.nextval, 'CTR_FED_HQC',
       PATH, 
       --FULL_PATH, 
       H_LEVEL, SPLAN_CAT_ID, SPLAN_CAT_ID_ORG, SPLAN_CAT_PARENT_ID, SPLAN_CAT_DESC, NOTE_NEXT_YEAR_PY, SPLAN_SECTION_CODE,
       -----------------
...
INSERT INTO SPLAN_NEXT_YEAR_TEMP ( SORT_ORDER, OUTPUT_TYPE, PATH, H_LEVEL, SPLAN_CAT_ID,
    ...
    SELECT SEQ_SPLAN_NEXT_YEAR_TEMP.nextval, 'GT',
           SUBSTR(SYS_CONNECT_BY_PATH(ml.SPLAN_CAT_ID, ','), 2) AS PATH, 
           LEVEL AS H_LEVEL, 
           DECODE (LEVEL, 1, SPLAN_PKG.f_getL3_SPLAN_CAT_ID(LEVEL, SUBSTR(SYS_CONNECT_BY_PATH(ml.SPLAN_CAT_ID, ','), 2)),
                          ml.SPLAN_CAT_ID ) AS SPLAN_CAT_ID,
...
INSERT INTO SPLAN_NEXT_YEAR_TEMP ( SORT_ORDER, OUTPUT_TYPE, PATH, H_LEVEL, SPLAN_CAT_ID,
                                   ...
                                   NOTE_NEXT_YEAR_PY, SPLAN_SECTION_CODE, AMOUNT_AS_OF_TODAY,
                                   AMOUNT_NEXT_YEAR_FOP,  AMOUNT_NEXT_YEAR_PY )
    SELECT SEQ_SPLAN_NEXT_YEAR_TEMP.nextval, 'APPRP',
           SUBSTR(SYS_CONNECT_BY_PATH(ml.SPLAN_CAT_ID, ','), 2) AS PATH, 
           LEVEL AS H_LEVEL, 
           ml.SPLAN_CAT_ID AS SPLAN_CAT_ID,
           DECODE (LEVEL, 1, SPLAN_PKG.f_getL3_SPLAN_CAT_ID(LEVEL, SUBSTR(SYS_CONNECT_BY_PATH(ml.SPLAN_CAT_ID, ','), 2)),
...
INSERT INTO SPLAN_NEXT_YEAR_TEMP ( SORT_ORDER, OUTPUT_TYPE, PATH, H_LEVEL, SPLAN_CAT_ID,
                                   ...
                                   NOTE_NEXT_YEAR_PY, SPLAN_SECTION_CODE, AMOUNT_AS_OF_TODAY,
                                   AMOUNT_NEXT_YEAR_FOP,  AMOUNT_NEXT_YEAR_PY )
    SELECT SEQ_SPLAN_NEXT_YEAR_TEMP.nextval, 'BBR',
           SUBSTR(SYS_CONNECT_BY_PATH(ml.SPLAN_CAT_ID, ','), 2) AS PATH, 
           LEVEL AS H_LEVEL, 
           DECODE (LEVEL, 1, SPLAN_PKG.f_getL3_SPLAN_CAT_ID(LEVEL, SUBSTR(SYS_CONNECT_BY_PATH(ml.SPLAN_CAT_ID, ','), 2)),
                          ml.SPLAN_CAT_ID ) AS SPLAN_CAT_ID,
...
-- OPEN rc_getAmount_RES FOR
    INSERT INTO SPLAN_NEXT_YEAR_TEMP ( SORT_ORDER, OUTPUT_TYPE, PATH, H_LEVEL, SPLAN_CAT_ID,
                                   ...
                                   NOTE_NEXT_YEAR_PY, SPLAN_SECTION_CODE, AMOUNT_AS_OF_TODAY,
                                   AMOUNT_NEXT_YEAR_FOP,  AMOUNT_NEXT_YEAR_PY )
    SELECT SEQ_SPLAN_NEXT_YEAR_TEMP.nextval, 'RES',
           SUBSTR(SYS_CONNECT_BY_PATH(ml.SPLAN_CAT_ID, ','), 2) AS PATH, 
           LEVEL AS H_LEVEL, 
           DECODE (LEVEL, 1, SPLAN_PKG.f_getL3_SPLAN_CAT_ID(LEVEL, SUBSTR(SYS_CONNECT_BY_PATH(ml.SPLAN_CAT_ID, ','), 2)),
                          ml.SPLAN_CAT_ID ) AS SPLAN_CAT_ID,
...
--OPEN rc_getAmount_BAR FOR
    INSERT INTO SPLAN_NEXT_YEAR_TEMP ( SORT_ORDER, OUTPUT_TYPE, PATH, H_LEVEL, SPLAN_CAT_ID,
                                   ...
                                   NOTE_NEXT_YEAR_PY, SPLAN_SECTION_CODE, AMOUNT_AS_OF_TODAY,
                                   AMOUNT_NEXT_YEAR_FOP,  AMOUNT_NEXT_YEAR_PY )
    SELECT SEQ_SPLAN_NEXT_YEAR_TEMP.nextval, 'BAR',
           SUBSTR(SYS_CONNECT_BY_PATH(ml.SPLAN_CAT_ID, ','), 2) AS PATH, 
           LEVEL AS H_LEVEL, 
           DECODE (LEVEL, 1, SPLAN_PKG.f_getL3_SPLAN_CAT_ID(LEVEL, SUBSTR(SYS_CONNECT_BY_PATH(ml.SPLAN_CAT_ID, ','), 2)),
                          ml.SPLAN_CAT_ID ) AS SPLAN_CAT_ID,
...
OPEN rc_DataOut FOR
SELECT SORT_ORDER, OUTPUT_TYPE, PATH, H_LEVEL, SPLAN_CAT_ID, SPLAN_CAT_ID_ORG, SPLAN_CAT_PARENT_ID,
       SPLAN_CAT_DESC,  NOTE_NEXT_YEAR_PY, SPLAN_SECTION_CODE, AMOUNT_AS_OF_TODAY, AMOUNT_NEXT_YEAR_FOP, AMOUNT_NEXT_YEAR_PY
  FROM SPLAN_NEXT_YEAR_TEMP 
ORDER BY SORT_ORDER;
