...
<cfset request.pageTitleDisplay = "PY  Spend Plan">

<cfset variables.nextTabIndex = 1>
<cfoutput>

<cfquery name="testSQL">INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (1, 'Before SP Call', SYSDATE )</cfquery>

<!--- Calling Database: --->
<!---<cfset strucGetSPlanNextYear_2 = application.ospend_plan.f_getSPlanNextYear_2(argUserID: "#session.userid#")>
<cfdump var="#strucGetSPlanNextYear_2#">
--->
<cfset strucGetSPlanNextYear = application.ospend_plan.f_getSPlanNextYear(argUserID: "#session.userid#")>
<!--- TEST all recordsets: <cfdump var="#strucGetSPlanNextYear#">--->

<cfquery name="testSQL">INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (2, 'After SP Call', SYSDATE )</cfquery>

<!---<cfabort>--->

<cfset variables.v_Current_PY = #strucGetSPlanNextYear.spr_getCurrentPY.CURRENT_PY#>
<cfset variables.v_Next_Year_PY = #strucGetSPlanNextYear.spr_getCurrentPY.NEXT_YEAR_PY#>

<cfset request.pageTitleDisplay = "PY#variables.v_Next_Year_PY# Spend Plan">
...
<!---
	<div id="budgetHeader">
		...
		<div id="budgetSubheaderRight">
			<!--- this is the right side of the subheader --->
		</div>
	</div><!--- budgetHeader --->
--->
...
<h2><cfoutput>#request.pageTitleDisplay#</cfoutput></h2> 
<form name="frmPage" id="frmPage" method="post" >	
   	<table width="100%" border="0" cellpadding="0" cellspacing="0"  class="contentTbl"  summary="Setting-up Next Year pend Plan">
            ...
            <tr>
                <th scope="col" style="text-align:center; color:##FFF" width="35%">&nbsp;</th>
                <th scope="col" style="text-align:center; color:##FFF" width="14%">PY#variables.v_Current_PY# Spend Plan<br />(as of #variables.v_TodayDate#)</th>
...
<!--- ......................... Beginning of strucGetSPlanNextYear.spr_getAmount_CTR_FED_HQC ................................. ---> 
<!---
...
--->
            ...
            <cfloop query="strucGetSPlanNextYear.spr_getAmount_CTR_FED_HQC" startrow="1" endrow="#strucGetSPlanNextYear.spr_getAmount_CTR_FED_HQC.RecordCount#">
...
<!--- ......................... End of strucGetSPlanNextYear.spr_getAmount_CTR_FED_HQC .......................................... --->            

<!--- ......................... Beginning of GRAND TOTAL strucGetSPlanNextYear.spr_getAmount_GT     ............................. ---> 
<!--- PATH, H_LEVEL, SPLAN_CAT_ID,  SPLAN_CAT_ID_ORG, SPLAN_CAT_PARENT_ID, SPLAN_CAT_DESC, 
       NOTE_NEXT_YEAR_PY, SPLAN_SECTION_CODE, AMOUNT_NEXT_YEAR_FOP, AMOUNT_NEXT_YEAR_PY --->
             <cfloop query="strucGetSPlanNextYear.spr_getAmount_GT" startrow="1" endrow="#strucGetSPlanNextYear.spr_getAmount_GT.RecordCount#">
             <tr id="idTr_GT">
...
<!--- ......................... End of GRAND TOTAL strucGetSPlanNextYear.spr_getAmount_GT .......................................... --->

<!--- ......................... Beginning of APPROPRIATION strucGetSPlanNextYear.spr_getAmount_APPRP  .............................. --->
             <cfloop query="strucGetSPlanNextYear.spr_getAmount_APPRP" startrow="1" endrow="#strucGetSPlanNextYear.spr_getAmount_APPRP.RecordCount#">
             <tr id="idTr_APPRP">
             	<td><div id="divCatDescr_#H_LEVEL#_#SPLAN_CAT_ID#">#SPLAN_CAT_DESC#</div></td>
                <td><div id="divAmntTody_#H_LEVEL#_#SPLAN_CAT_ID#">#AMOUNT_AS_OF_TODAY#</div></td>
                <td><div id="divAmntFOPPY_#H_LEVEL#_#SPLAN_CAT_ID#">#AMOUNT_NEXT_YEAR_FOP#</div></td>
...
<!--- ......................... End of APPROPRIATION strucGetSPlanNextYear.spr_getAmount_APPRP .................................... --->
 
<!--- ......................... Beginning of BALANCE BEFORE RESERVE strucGetSPlanNextYear.spr_getAmount_BBR  ...................... --->
			 <cfloop query="strucGetSPlanNextYear.spr_getAmount_BBR" startrow="1" endrow="#strucGetSPlanNextYear.spr_getAmount_BBR.RecordCount#">
             <tr id="idTr_BBR">
             	<td><div id="divCatDescr_#H_LEVEL#_#SPLAN_CAT_ID#">#SPLAN_CAT_DESC#</div></td>
                <td><div id="divAmntTody_#H_LEVEL#_#SPLAN_CAT_ID#">#AMOUNT_AS_OF_TODAY#</div></td>
                <td><div id="divAmntFOPPY_#H_LEVEL#_#SPLAN_CAT_ID#">#AMOUNT_NEXT_YEAR_FOP#</div></td>
...
<!--- ......................... End of BALANCE BEFORE RESERVE strucGetSPlanNextYear.spr_getAmount_BBR ............................ --->

<!--- ......................... Beginning of RESERVE strucGetSPlanNextYear.spr_getAmount_RES  .................................... --->             
             <cfloop query="strucGetSPlanNextYear.spr_getAmount_RES" startrow="1" endrow="#strucGetSPlanNextYear.spr_getAmount_RES.RecordCount#">
             <tr id="idTr_RES">
             	<td><div id="divCatDescr_#H_LEVEL#_#SPLAN_CAT_ID#">#SPLAN_CAT_DESC#</div></td>
                <td><div id="divAmntTody_#H_LEVEL#_#SPLAN_CAT_ID#">#AMOUNT_AS_OF_TODAY#</div></td>
                <td><div id="divAmntFOPPY_#H_LEVEL#_#SPLAN_CAT_ID#">#AMOUNT_NEXT_YEAR_FOP#</div></td>
...
<!--- ......................... End of RESERVE strucGetSPlanNextYear.spr_getAmount_RES ......................................... --->

<!--- ......................... Beginning of BALANCE BEFORE RESERVE strucGetSPlanNextYear.spr_getAmount_BAR  ................... --->              
             <cfloop query="strucGetSPlanNextYear.spr_getAmount_BAR" startrow="1" endrow="#strucGetSPlanNextYear.spr_getAmount_BAR.RecordCount#">
             <tr id="idTr_BAR">
             	<td><div id="divCatDescr_#H_LEVEL#_#SPLAN_CAT_ID#">#SPLAN_CAT_DESC#</div></td>
                <td><div id="divAmntTody_#H_LEVEL#_#SPLAN_CAT_ID#">#AMOUNT_AS_OF_TODAY#</div></td>
                <td><div id="divAmntFOPPY_#H_LEVEL#_#SPLAN_CAT_ID#">#AMOUNT_NEXT_YEAR_FOP#</div></td>
...
<!--- ......................... End of BALANCE BEFORE RESERVE strucGetSPlanNextYear.spr_getAmount_BAR ......................... --->
                    
             <tr>
                    <td colspan="3" align="left">
                    	<cfloop query="strucGetSPlanNextYear.spr_getTransClosed" startrow="1" endrow="#strucGetSPlanNextYear.spr_getTransClosed.RecordCount#">
                        ...
                        <input type="button" name="btnCreateSplan" id="btnCreateSplan"  #variables.btnDisabled#
                        	   value="Create PY #variables.v_Next_Year_PY# Spend Plan" tabindex="#variables.nextTabIndex#"/>
                        <cfset variables.nextTabIndex = variables.nextTabIndex + 1>
                    </td>
...
function f_onClick(arg_CtrlName)
{
	...
	switch (arg_CtrlName)
	{
		case "btnSave":
			...
			//else
			//{
			//	alert("No changes have been made. 'Save' procedure will not be performed.");	
			//}
		break;
		//
		case "btnClear":
		...
		case "btnCreateSplan":
			...
			{
					f_msgShowHide("CHANGES_NO");
					if ( confirm("Are you sure you want to generate the PY#variables.v_Next_Year_PY# Spend Plan?\n"+
								...
								"Click 'Cancel' to remain on this page.") )
				  {
					  ...
					  of_Submit("splan_approp_allot_controller.cfm?actionMode=setNextYearSplan"+
					  											  "urlUserID="+v_UserID+"&"+
...
function f_createArgsForSave(){with(self.document.frmPage)
{
	...
	$("input[id^=txtSPNextPY]").each(function()
	{
		...
		if (v_Note==''){v_Note="NOVAL"}
//		
		v_Splan = v_Splan+v_SplanCatID+"_"+v_Amnt+"_"+v_Note+"^"; 

	});	//
	//v_Splan = v_Splan.substr(0,v_Splan.length-1);
...
var v_CtlrPrefix="",
	...
	v_RES_Percent="#strucGetSPlanNextYear.spr_getResPercent.RES_PERCENT#";	
...
<cfquery name="testSQL">INSERT INTO Z_TEST_TEST (C_NUMBER, C_VARCHAR, C_DATE ) VALUES (3, 'End of file', SYSDATE )</cfquery>
