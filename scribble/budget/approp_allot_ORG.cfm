	...
	<tr>
        <td >
            <table border="0" width="100%" cellspacing="0" cellpadding="0" >
            	<tr>
                    ...
                    <td align="right">
                        <select name="sel_ListOfPY" id="sel_ListOfPY" 
                                ...
                                onfocus="f_selOnFocus(this.name);">  <!--- onchange="f_onChange(this.name);" --->
                ...
                <tr>
                	<td colspan="2"><div id="divLoadMsgNCFMS">#strucAppropAllot.spr_getDateNCFMSloaded.NCFMS_LOAD_MSG#</div></td>
                </tr>
            </table>
        </td>
  </tr>
