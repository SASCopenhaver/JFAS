...
<cfscript>
	...
	fileDirName = fileDir & "BudgetAppropAllot.xls"; 
</cfscript>

<cfset sObjApprop=SpreadsheetNew()>
<cfset sObjAllot=SpreadsheetNew()>

<cfset SpreadsheetAddRow(sObjApprop, "APPROPRIATION ID,appr_fund_cat,appr_fund_cat_desc,appr_py,appr_amount,appr_amount_ncfms")>
...
<cfset SpreadsheetAddRow(sObjAllot, "ALLOT_ID,FUND_CAT,FUNDING_OFFICE_NUM,FUNDING_OFFICE_DESC,PY,Q1_AMOUNT,Q2_AMOUNT,Q3_AMOUNT,Q4_AMOUNT,QT_AMOUNT,Q1_AMOUNT_NCFMS,Q2_AMOUNT_NCFMS,Q3_AMOUNT_NCFMS,Q4_AMOUNT_NCFMS,QT_AMOUNT_NCFM")>
...
<cfspreadsheet action="update" filename="#fileDirName#" name="sObjAllot" sheetname="Allotment">

<!---<cfscript>  
	fileName = FileOpen("#fileDirName#"); 
</cfscript>--->

<!----
<cfheader name="Content-Disposition" value="attachment; filename=Budget_Appropriation_Allotment.xls">
