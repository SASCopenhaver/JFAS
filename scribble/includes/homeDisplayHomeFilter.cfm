...
<div id="idHomeFilterGuts" class="homeFilterGuts">
	...
	<table width="60%" border="0" cellspacing="0" cellpadding="0" summary="Filtering Controls for AAPP List">
		...
		<!--- on submit executes JS to redisplay jfasDataDiv. This action is implemented by
			...
			which executes submitFiltersPanel() to do the ajax call in displayAAPPsAjax()
		--->
...
<cffunction name="DisplayDatePair">
	...
	<div id="#arguments.idDiv#" class="btn-group-vertical btn-group-sm filterSelectorCheckboxes">
		...
		<cfset DisplayMSCalendar(
		"frmHomeFilter"
		, arguments.fieldName1
		, 'Use Calender for ' & sAltText1
		)>
		to
		</label></div>
		<!-- /filterdate -->
		...
		<cfset DisplayMSCalendar(
		"frmHomeFilter"
		, arguments.fieldName2
		, 'Use Calender for ' & sAltText2
		)>
...
<cffunction name="DisplayMSCalendar" output="true">
	<cfargument name="formName">
	<cfargument name="fieldName">
	<cfargument name="altText">

	<cfset var sFormField = arguments.formName & "." & arguments.fieldName>
	<a class="ImgOnFilterTab usetooltip" data-toggle="tooltip" data-placement="top" title="#arguments.altText#"  href="javascript:MS_ShowFieldPopCalendar(#sFormField#, 'M/D/Y')">
	<img src="#application.paths.images#date.png" border="0" name="#arguments.fieldName#" alt="#arguments.altText#" style="margin: 0 2px 4px 2px;" /></a>
	<cfreturn>

</cffunction> <!--- DisplayMSCalendar --->
