...
tGrStruct = structNew();
tGrStruct = application.ographicsUtils.graphicSetForAAPPNum( url.aapp, session.userID, "Cumulative FOP by Execution Date", "JFG LINE1FOP" );
