...
---><!---<cfdump var="#rtn_getAllotmentAsCSV#">--->
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
//-------------------------------------------
[
	{"PY":"21", "ALLOT_AMOUNT":124},
	{"PY":"2011", "ALLOT_AMOUNT":81},
	{"PY":"2012", "ALLOT_AMOUNT":12},
	{"PY":"2013", "ALLOT_AMOUNT":102},
	{"PY":"2014", "ALLOT_AMOUNT":94},
	{"PY":"2015", "ALLOT_AMOUNT":21},
]

//d3.csv()
d3.json("py_allot.json", function(arg_Data) {
	var v_Canvas = d3.select("body")
						.append("svg")
						.attr("width", 500)
						.attr("height", 500)
	v_Canvas.selectAll("rect")
				...
				.enter()
					.append("rect")
					.attr("width", function(d){return d.py;} )
					.attr("height",50)
