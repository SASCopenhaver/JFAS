...
<tr>
	...
	<td>
		<input type="text" name="txtReleaseDate" id="idReleaseDate" value="#DateFormat(form.txtReleaseDate, 'mm/dd/yyyy')#" tabindex="#request.nextTabIndex#" size="15" maxlength="15" />
		<a href="javascript:MS_ShowFieldPopCalendar(document.frmRelease.txtReleaseDate, 'M/D/Y')">
			<img src="#application.paths.images#calendar_icon.gif" border="0" alt="Select to specify ReleaseDate" width="16" height="13" />
		</a>
		<cfset request.nextTabIndex = request.nextTabIndex + 1>
	</td>
</tr>
