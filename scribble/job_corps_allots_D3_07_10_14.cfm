...
//( function(){
	...
	*/	   
	...
	// TESTs: console.log(nodes); console.log(links);
/*	
	var node = canvas.selectAll(".node")
						.data(nodes)
						.enter()
...
$(document).ready(function(){
	var jqXHR = $.ajax({
				 ...
				 .success (function(objAllotmentGraph_JSON, statusTxt, xhr){
					 ...
					 f_DrawFundOfficeAllotment( f_makeWorkableJSON( $.parseJSON(objAllotmentGraph_JSON) ) );
