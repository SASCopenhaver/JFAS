...
<h2>Program Year Initial CCC Budget (by Center)</h2>

<cfparam name="form.cboAAPP" type="numeric" default="0">
<cfparam name="form.cboCenter" default="0">
<cfparam name="form.cboPY" type="numeric" default="0">
...
<tr>
	...
	<td>
		...
		<select name="cboAAPP" id="idAAPP" tabindex="#request.nextTabIndex#" onChange="checkCenter(this.form.cboAAPP, this.form.cboCenter);">
			<option value="0">Select AAPP No.</option>
