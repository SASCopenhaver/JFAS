<cfsilent>
<!---
page: crit_estimated_cost_profile.cfm

description: criteria page for estimated cost profile report
...
<tr valign="top">
	<td width="25%" align="right"><fieldset><legend align="right">Cost Category</legend></td>
	<td></td>
	<td width="75%">
